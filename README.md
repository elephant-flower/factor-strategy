...
| 指标 | 重构前 | **重构后** |
|------|--------|-----------|
| 回测区间 | 2024-01 ~ 2026-05 | **2022-01 ~ 2026-05** |
| 交易标的 | 动态选择活跃券 | **210210（10Y国开债）** |
| 交易次数 | 9 | **35** |
| 胜率 | 11.1% | **42.9%** |
| 总盈亏 | -57元 | **+1,248,700元** |
| 夏普比率 | -4.51 | **3.64** |
...
> **重构说明**：将复杂的宏观+资金流+趋势三层因子系统，简化为直接基于YTM均线交叉的趋势跟踪策略。使用单一活跃国开债（210210）避免了活跃券选择不稳定问题。止盈5BP/止损3BP取得了优异的盈亏比。
