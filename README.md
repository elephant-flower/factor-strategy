...
| 指标 | 优化前 | **优化后** |
|------|--------|-----------|
| 信号逻辑 | DR007/MLF/PMI/CPI/IVA严格条件 | **五因子投票系统（score≥2出信号）** |
| 资金流向 | 成交量+持续价格变动 | **量价配合（YTM+close+volume）** |
| 趋势方向 | 收盘价MA交叉 | **YTM均线交叉（5/20日）** |
| 活跃券选择 | 随机选取有数据债券 | **优先主力210210（10Y国开债）** |
| 止盈/止损 | 8BP / 5BP | **5BP / 3BP** |
| 止损检查 | 使用当日活跃券YTM | **使用持仓债券YTM** |
| 交易次数 | 9 | **15** |
| 总盈亏 | -57元 | **+1,359,500元** |
| 夏普比率 | -4.51 | **2.77** |
| 最大回撤 | 0.00% | **0.00%** |
